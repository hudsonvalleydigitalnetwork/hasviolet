#!/usr/bin/python3
#
# HVDN LORA MESSAGE RDL
#
# hvdncomm-lora-message_rdl.py
#
# Usage: hvdncomm-lora-message_rdl.py destination-node "message"
#
# Dependencies:
#
#     This enables and uses the raspi-lora library
#
#     https://pypi.org/project/raspi-lora/
#
# Revisions:
#
#     Alpha  - 20180828: Initial Success using raspi-lora library
#
#
# To-do:
