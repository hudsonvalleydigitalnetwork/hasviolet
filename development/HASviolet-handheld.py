...
def duckhunt(level):
    print(level)
    if duck.simple_trigger=="T":
        duck.simple_action
    elif duck.simple_trigger=="E":
        duck.simple_action
    elif duck.simple_trigger=="S":
...
def game_simple(duck.simple_message, duck.simple_interval, duck.simple_trigger, duck.trigger_action):
    print("Simple")
    hasvheader = HASit.station + ">" + "BEACON-99"
    hasvpayload = hasvheader + " | " + duck.simple_message 
    while HAShat.btnRight.value:
...
def game_harder(duck.harder_message, duck.harder_interval, duck.harder_trigger, duck.hardcore_action):
    print("Harder")
    hasvheader = HASit.station + ">" + "BEACON-99"
...
def game_hardcore(duck.hardcore_message, duck.hardcore_interval, duck.hardcore_trigger, duck.hardcore_action):
    print("Hardcore")
    while HAShat.btnRight.value:
